"""
Django settings for greensleeves project.
...
WSGI_APPLICATION = 'greensleeves.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'greensleeves'
    ...
    # Overide static and media files in production
